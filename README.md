...
## Motivation
react를 사용하여 프로젝트를 해보고 싶었다. 규칙이 복잡하지 않으면서도 재미있는 Othello를 대상으로 정했다.
...
```
## Screenshots
1. 흑의 차례. 프로필 테두리에 색이 생긴다. 프로필 하단에는 현재 보드 위에 소유한 돌의 개수가 표시된다. 흑이 둘 수 있는 공간에 네모로 표시가 되어있다. 
...
2. 둘 수 있는 위치에 마우스를 가져가면, 뒤집어 지는 돌의 색이 바뀌고 테두리가 생긴다. 
